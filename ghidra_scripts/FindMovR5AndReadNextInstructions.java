...
public class FindMovR5AndReadNextInstructions extends GhidraScript {
    ...
    protected void run() throws Exception {
        ...
        byte[] movR3Pattern = { (byte) 0x7d }; // MOV R3, imm
        ...
        byte[] movR3PatternMask = { (byte) 0x7d }; // MOV R3, imm
        ...
        while (matchAddr != null) {
            ...
            if (instr != null && instr.getMnemonicString().equals("MOV") &&
                ...
                util.getValuesFromRegistersR5(instr);
